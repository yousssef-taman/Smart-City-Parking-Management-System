...
public interface SpotRepository extends JpaRepository<Spot, Integer> {
        ...
        @Modifying
        @Transactional
        @Query(value = "INSERT INTO SmartParking.spot(lot_id , status , type) VALUES\n" +
                        "(:lotID , 2 , :type ); ", nativeQuery = true)
        ...
        @Query(value = "SELECT * FROM SmartParking.spot WHERE lot_id = :lotId", nativeQuery = true)
